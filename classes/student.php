...
class Student extends database{
    public $room,$food,$stayFrom,$duration,$course,$regNum,$fName,$mName,$lName,$gender,$contact,$email,$emContact,$guardName,$guardRel,$guardContact,$corrAddress,$corrCity,$corrState,$corrPin,$permAddress,$permCity,$permState,$permPin,$room_name,$room_seater,$course_name,$room_fee;
            ...
            while($row = $result->fetch_array()){
                echo '
                    <tr>
                        ...
                        <td>'.$row['student_reg_num'].'</td>
                        <td>'.$row['student_contact'].'</td>
                        <td>'.$row['room_num'].'</td>
                        <td>'.$row['room_seater'].'</td>
                        <td>'.$row['student_stay_from'].'</td>
                        <td>
                            <a href="student-details?id='.$row['student_id'].'"><i class="fas fa-edit"></i></a>
                            <a href="manage-students.php?del='.$row['student_id'].'"><i class="fas fa-trash-alt"></i></a>
                        </td>
                    </tr>
